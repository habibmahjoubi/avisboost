...
export const NICHE_CONFIGS: NicheConfigs = {
  ...
  <p style="color:#888;font-size:13px">À très bientôt !<br>L'équipe {{businessName}}</p>
</div>`,
        },
        {
          name: "Relance",
          ...
          body: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;background:#ffffff;color:#1a1a1a">
  <h2>Votre avis nous intéresse toujours</h2>
  <p>Bonjour {{clientName}},</p>
  ...
  <a href="{{link}}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;margin:16px 0">Donner mon avis</a>
  <p style="color:#888;font-size:13px">Merci d'avance !<br>L'équipe {{businessName}}</p>
</div>`,
        },
      ],
      SMS: [
  ...
  <a href="{{link}}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;margin:16px 0">Laisser un avis</a>
  <p style="color:#888;font-size:13px">Prenez soin de vous !<br>{{businessName}}</p>
</div>`,
        },
        {
          name: "Relance",
          ...
          body: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;background:#ffffff;color:#1a1a1a">
  <h2>Votre retour nous intéresse</h2>
  <p>Bonjour {{clientName}},</p>
  ...
  <a href="{{link}}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;margin:16px 0">Donner mon avis</a>
  <p style="color:#888;font-size:13px">Merci d'avance !<br>{{businessName}}</p>
</div>`,
        },
      ],
      SMS: [
  ...
  GARAGE: {
    ...
    templates: {
      ...
      EMAIL: {
        ...
        body: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;background:#ffffff;color:#1a1a1a">
  <h2>Votre véhicule roule bien ?</h2>
  <p>Bonjour {{clientName}},</p>
  ...
  <a href="{{link}}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;margin:16px 0">Donner mon avis</a>
  <p style="color:#888;font-size:13px">Merci et à bientôt !<br>L'équipe {{businessName}}</p>
</div>`,
      },
    },
    presets: {
  ...
  <a href="{{link}}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;margin:16px 0">Laisser un avis</a>
  <p style="color:#888;font-size:13px">Bonne route !<br>L'équipe {{businessName}}</p>
</div>`,
        },
        {
          name: "Relance",
  ...
  <p style="color:#888;font-size:13px">À bientôt !<br>L'équipe {{businessName}}</p>
</div>`,
        },
        {
          name: "Relance",
